...
{
    internal class HeadSprite : ICharacterSprite, IHead
    {
        ...
        public HeadSprite(GameCharacter gameCharacter)
        {
            var sprite = new AnimatedSprite(rowCount: 8, columnCount: 32, "Assets/Isometric_Hero/male_head2.png", this);
